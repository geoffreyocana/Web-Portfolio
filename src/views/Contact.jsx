  ...
  return (
    ...
    >
            ...
            <form>
              ...
              <div className="flex justify-between ">
                ...
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:geoffreyocana@gmail.com">Submit</a>
                </button>
              </div>
            </form>
          </div>
      ...
      <div
        className={
          darkMode
            ? "w-full bg-white text-black py-6"
            : "w-full bg-gray-900 text-white py-6"
        }
      >
        <hr className={darkMode ? "border-gray-300" : "border-gray-100"} />
        <p className="text-center text-sm mt-4">
          &copy; {new Date().getFullYear()} Geoffrey Oca&ntilde;a. All rights reserved.
        </p>
      </div>
    </div>
  );
